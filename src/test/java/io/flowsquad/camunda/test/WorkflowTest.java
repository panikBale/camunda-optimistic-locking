...
import io.flowsquad.camunda.test.delegates.MailingService;
import io.flowsquad.camunda.test.delegates.RollbackScenario;
import io.flowsquad.camunda.test.delegates.SendCancellationDelegate;
...
public class WorkflowTest {
    ...
    public static final String TASK_ROLLBACK_SCENARIO = "rollbackScenario";
    ...
    public void defaultScenario() {
        ...
        Mocks.register(TASK_ROLLBACK_SCENARIO, new RollbackScenario());
    ...
    public void shouldExecuteHappyPath() {
        Map<String, Object> variables = Variables.createVariables()
                .putValue(VAR_CUSTOMER, "john")
                .putValue(VAR_PRODUCTS_AVAILABLE, true);
//                .putValue("test", true);
...
//        verify(testOrderProcess).hasFinished(END_EVENT_ORDER_FULLFILLED);

//        rule.addTestMethodCoverageAssertionMatcher("shouldExecuteHappyPath", greaterThanOrEqualTo(0.1));
    }
...
//        when(testOrderProcess.waitsAtUserTask(TASK_CHECK_AVAILABILITY)).thenReturn(task -> {
//            task.complete(withVariables("test", false));
//        });
